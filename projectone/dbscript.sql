...
USERS Table
create table users (id int generated always as identity, name varchar(40) , password varchar(40) , email varchar(150) , usertype_id int, addres varchar(200), contact varchar(40)); 
